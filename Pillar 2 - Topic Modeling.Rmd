...
result_topic_test <- map(.x = d_cast, .f = my_FindTopicsNumber, n_topics = seq(from = 5, to = 15, by = 5))
...
save(result_manual, result_overview ,
     file = "Output/LDA_ntopics.RDATA")
...
The following functions allow us to inspect the distributions and get kw
```{r}
# FUNCTION
...
#   name_selected <- deparse(substitute(d_distribution))
#   beta_gamma_sym <- tolower(name_selected)
#   
#   #prepare variables for grouping
