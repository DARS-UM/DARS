...
category <-quo(Discrete_grade) #Outcome or Low_grade or Discrete_grade or #None
...
frequent_trajectories <- cspade(transactions, parameter = list(support = 0.01), control   = list(verbose = TRUE))


summary(frequent_trajectories)


rules <- ruleInduction(frequent_trajectories, confidence = 0.1, #we need to play with the parameters.
