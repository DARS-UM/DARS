...
# Extracting description (UCM only)
...
```{r description}
d_text$description <- d_text$overview %>% mutate(text = text %>% map_chr(extract_description))
```
