...
find_prep <- function(objective){
  ...
  if(nrow(data_temp) <= 7) return(NULL)
  
  #
  # best subset selection
  m <- regsubsets(Grade ~ ., data_temp, nvmax = 6)
  
  coefi <- coef(m, 6)[-1]  # check that 6 is usually a good subset size
