...
grViz("digraph flowchart{
      ...
      style = filled;
		  color = lightgrey;
		  node [style = filled, color = black, fillcolor = white, shape = cylinder];
...
df_logLike_catalogue %>%
  ...
  labs(title = "Model Selection", subtitle = "The maximum-likelihood model has 80 topics", x = "Number of Topics", y = "Log-Likelihood") +
