...
d_transcript <- rbind(
  read_csv("Raw Grades/grades1.csv", 
           col_types = cols(`Program (Abbreviation)`=col_character(), `Appraisal Status`= col_character(), `Module Booking Reason (Description)`= col_character(), `Object name` = col_character(), `Start date` = col_character(),`End Date` = col_character()
                              )
           ),
  read_csv("Raw Grades/grades2.csv", 
           col_types = cols(`Program (Abbreviation)`=col_character(), `Appraisal Status`= col_character(), `Module Booking Reason (Description)`= col_character(), `Object name` = col_character(), `Start date` = col_character(), `End Date` = col_character()
           )
           )
  )
