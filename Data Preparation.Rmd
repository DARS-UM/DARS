...
```{r creating dictionary, cache = TRUE}
...
rm(stem_hunspell, my_dictionary, stem_with_dictionary)
...
rm(stem_hunspell, my_dictionary, remove_sw, sw_own)
```
