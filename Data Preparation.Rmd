...
Our dataframe contains many variables that are either empty or meaningless for our analysis, thus we select ony the 10 variables that we will use for the anlysis, and give them more comprehensible names.
