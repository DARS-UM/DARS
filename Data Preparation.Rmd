...
```
## Student Data
The tibble `d_transcripts` contains the transcripts information of students as was provided. It has 40 columns, and rows correspond to a type of grade (e.g. final grade, attendance) per student per course per time they took it.
...
rm(n_catalogue, calendar_years, course_code, content_to_exclude,
